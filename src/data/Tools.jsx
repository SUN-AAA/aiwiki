const Tools = [
        ...
        },
        {
            ...
            category: "코딩",
            platform: "통합개발환경(IDE)",
            content: "Cursor : Visual Studio Code를 포크해서 만들어진 통합 개발 환경으로, 코드 작성, 디버깅, 수정 등 다양한 개발 작업을 AI의 도움으로 효율화할 수 있는 툴이다. Cursor는 GPT-4o, Claude 4 Sonnet 등 다양한 AI 모델을 지원하며, 코드 작성 및 디버깅 속도를 대폭 향상시키는 것을 목표로 하고 있다. 또한 자연어를 활용해 코드 작성, 수정, 명령어 변환 등 다양한 작업을 간단히 수행할 수 있다.",
