...
📦src
 ...
 ┃ ┗ 📜Tools.jsx                 //AI 툴 데이터
 ┣ 📂pages                     //페이지
 ┃ ┣ 📜Detail.jsx                //detail 페이지
 ┃ ┣ 📜Home.jsx                  //home 페이지
 ┃ ┗ 📜Notfound.jsx              //notfound 페이지
 ┣ 📂styles                    //스타일시트 모음
 ┃ ┣ 📜Detail.css                //deatil 페이지 스타일시트
 ┃ ┣ 📜Header.css                //헤더 스타일시트
 ┃ ┣ 📜Home.css                  //home 페이지 스타일시트
 ┃ ┗ 📜List.css                  //AI 툴 리스트 스타일시트
 ┣ 📂utils                     //기능 함수 모음
 ┃ ┗ 📜getFilteredData.jsx       //검색 결과 반환 함수
 ┣ 📜App.css                   
 ┣ 📜App.jsx
 ┣ 📜index.css
 ┗ 📜main.jsx
